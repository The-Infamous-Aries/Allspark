...
from Systems.EnergonPets.battle_system import MONSTER_EMOJIS, RARITY_EMOJIS
...
class EnemySelectionView(discord.ui.View):
    ...
    async def start_battle(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        try:
            from Systems.EnergonPets.battle_system import UnifiedBattleView
            ...
            if self.battle_type == "group":
                ...
                embed = battle_view.build_battle_embed("Battle started! Good luck!")
                await self.message.edit(embed=embed)
                
                # Start action collection via DM
