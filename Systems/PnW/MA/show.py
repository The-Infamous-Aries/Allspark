    ...
    async def generate_nation_military_embed(self):
        try:
            ...
            embed.add_field(
                ...
                value=(
                    f"🪖 **Soldiers:** {limits.get('soldiers', limits.get('soldiers_daily', 0)):,}/day\n"
                    f"🛡️ **Tanks:** {limits.get('tanks', limits.get('tanks_daily', 0)):,}/day\n"
                    f"✈️ **Aircraft:** {limits.get('aircraft', limits.get('aircraft_daily', 0)):,}/day\n"
                    f"🚢 **Ships:** {limits.get('ships', limits.get('ships_daily', 0)):,}/day"
                ),
                inline=False
            )
