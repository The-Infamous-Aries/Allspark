...
class AllsparkBot(commands.Bot):
    ...
    async def on_member_join(self, member):
        ...
        embed.add_field(name="📋 Server Rules", value="Please read <#1299147811161505803>", inline=False)
        embed.add_field(name="🎫 Here to Apply?", value="Create a ticket in <#1294362865435807764>", inline=False)
        embed.add_field(name="🏛️ Building Government?", value="Join our gov server: https://discord.gg/7YVJmtMZKN", inline=False)
