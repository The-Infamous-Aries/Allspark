...
class AllsparkBot(commands.Bot):
    ...
    async def load_all_modules(self):
        ...
        # Load modules in dependency order to ensure proper initialization
        primary_modules = [
    ...
    def log_startup_summary(self):
        ...
        secondary_loaded = [m for m in self.loaded_modules if m in [
            ...
            'pets_system', 'pets_commands', 'battle_commands'
        ]]
...
class FeaturesView(discord.ui.View):
    def __init__(self):
        ...
        self.current_page = 0
        self.commands = 15  # Default to Everyone commands count
        self.pages = [
            {
...
`/slots` - Play the Energon slot machine""",
            ...
            {
                "title": "🐾 Digital Pets & Equipment (19 commands)",
                "description": """📊 **Stat Viewers**
