...
CYBERTRON_ALLIANCE_ID = os.getenv('CYBERTRON_ALLIANCE_ID', '9445')
PRIME_BANK_ALLIANCE_ID = os.getenv('PRIME_BANK_ALLIANCE_ID', '14110')
TCO_ALLIANCE_ID = os.getenv('TCO_ALLIANCE_ID', '14036')
NORTHERN_CONCORD_ALLIANCE_ID = os.getenv('NORTHERN_CONCORD_ALLIANCE_ID', '14177')
UNION_OF_NATIONS_ALLIANCE_ID = os.getenv('UNION_OF_NATIONS_ALLIANCE_ID', '14124')
TRIUMVIRATE_ALLIANCE_ID = os.getenv('TRIUMVIRATE_ALLIANCE_ID', '13893')
RECLAIMED_FLAME_ALLIANCE_ID = os.getenv('RECLAIMED_FLAME_ALLIANCE_ID', '14230')
...
ARIES_NATION_ID = 680891
CARNAGE_NATION_ID = 596529  
PRIMAL_NATION_ID = 334649
BENEVOLENT_NATION_ID = 541679
TECH_NATION_ID = 701277
